...
impl DefaultIO {
    pub fn new() -> DefaultIO {
        DefaultIO {
            io: AiFileIO {
                open: default_open_proc,
                close: default_close_proc,
...
extern "C" fn default_open_proc(file_io: *mut AiFileIO, path: *const c_char, _mode: *const c_char) -> *mut AiFile {
...
extern "C" fn default_close_proc(file_io: *mut AiFileIO, file: *mut AiFile) {
    c_assert!(!file_io.is_null());
...
extern "C" fn default_read_proc(file: *mut AiFile, buffer: *mut c_char, size: size_t, count: size_t) -> size_t {
...
extern "C" fn default_write_proc(file: *mut AiFile, buffer: *const c_char, size: size_t, count: size_t) -> size_t {
    let mut file: &mut File = user_data!(file);
...
extern "C" fn default_tell_proc(file: *mut AiFile) -> size_t {
    let mut file: &mut File = user_data!(file);
...
extern "C" fn default_tell_size_proc(file: *mut AiFile) -> size_t {
...
extern "C" fn default_seek_proc(file: *mut AiFile, pos: size_t, origin: c_int) -> c_int {
    let mut file: &mut File = user_data!(file);
...
extern "C" fn default_flush_proc(file: *mut AiFile) {
    let mut file: &mut File = user_data!(file);
